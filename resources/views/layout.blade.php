...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- RoomMaster -->
            <li class="nav-item">
                <a class="nav-link @if (!request()->is('admin/rooms*')) collapsed @endif" href="#"
            ...
            <!-- CompanyMaster -->
            <li class="nav-item">
                <a class="nav-link @if (!request()->is('admin/company*')) collapsed @endif" href="#"
                    data-toggle="collapse" data-target="#companyMaster" aria-expanded="true"
                    aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-building"></i>
                    <span>Company</span>
                </a>
                <div id="companyMaster" class="collapse @if (request()->is('admin/company*')) show @endif"
                    aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('admin/company/create') }}">Add New</a>
                        <a class="collapse-item" href="{{ url('admin/company') }}">View All</a>
                    </div>
                </div>
            </li>
            ...
            <!-- CustomerMaster -->
            <li class="nav-item">
                <a class="nav-link @if (!request()->is('admin/client*')) collapsed @endif" href="#"
                    data-toggle="collapse" data-target="#CustomerMaster" aria-expanded="true"
                    aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Clients</span>
                </a>
                <div id="CustomerMaster" class="collapse @if (request()->is('admin/client*')) show @endif"
                    aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('admin/client/create') }}">Add New</a>
                        <a class="collapse-item" href="{{ url('admin/client') }}">View All</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Staff -->
            <li class="nav-item">
                <a class="nav-link @if (!request()->is('admin/staff*')) collapsed @endif" href="#"
                    data-toggle="collapse" data-target="#StaffMaster" aria-expanded="true"
                    aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Staff</span>
                </a>
